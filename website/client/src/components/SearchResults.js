        ...
        <div className="search-section row">
          <form action='POST' onSubmit={handleSubmit}>
            <div className='col-lg-12 input-group search-bar'>
              ...
              <input className='form-control' name='search' type='text' placeholder='Search for song/videos....' aria-label='Search' value={searchText} onChange={(e) => setSearchText(e.target.value)} />
            </div>
